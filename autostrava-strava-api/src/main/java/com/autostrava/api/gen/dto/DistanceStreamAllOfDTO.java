...
public class DistanceStreamAllOfDTO   {
  @JsonProperty("data")
  @Valid
  private List<Float> data = null;

  public DistanceStreamAllOfDTO data(List<Float> data) {
    this.data = data;
    return this;
  }

  public DistanceStreamAllOfDTO addDataItem(Float dataItem) {
    if (this.data == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DistanceStreamAllOfDTO distanceStreamAllOf = (DistanceStreamAllOfDTO) o;
    return Objects.equals(this.data, distanceStreamAllOf.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DistanceStreamAllOfDTO {\n");
