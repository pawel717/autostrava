...
import com.autostrava.api.gen.dto.TimeStreamAllOfDTO;
...
public class TimeStreamDTO   {
  ...
  public TimeStreamDTO originalSize(Integer originalSize) {
  ...
  */
  ...
  public TimeStreamDTO resolution(ResolutionEnum resolution) {
  ...
  */
  ...
  public TimeStreamDTO seriesType(SeriesTypeEnum seriesType) {
  ...
  */
  ...
  public TimeStreamDTO data(List<Integer> data) {
    this.data = data;
    return this;
  }

  public TimeStreamDTO addDataItem(Integer dataItem) {
    if (this.data == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TimeStreamDTO timeStream = (TimeStreamDTO) o;
