 ...
 */
@JsonPropertyOrder({
  CadenceStreamDTO.JSON_PROPERTY_ORIGINAL_SIZE,
  CadenceStreamDTO.JSON_PROPERTY_RESOLUTION,
  CadenceStreamDTO.JSON_PROPERTY_SERIES_TYPE,
  CadenceStreamDTO.JSON_PROPERTY_DATA
})
