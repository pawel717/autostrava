...
public class HeartrateStreamAllOfDTO   {
  @JsonProperty("data")
  @Valid
  private List<Integer> data = null;

  public HeartrateStreamAllOfDTO data(List<Integer> data) {
    this.data = data;
    return this;
  }

  public HeartrateStreamAllOfDTO addDataItem(Integer dataItem) {
    if (this.data == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HeartrateStreamAllOfDTO heartrateStreamAllOf = (HeartrateStreamAllOfDTO) o;
    return Objects.equals(this.data, heartrateStreamAllOf.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class HeartrateStreamAllOfDTO {\n");
