...
import com.autostrava.api.gen.dto.SmoothGradeStreamAllOfDTO;
...
public class SmoothGradeStreamDTO   {
  ...
  public SmoothGradeStreamDTO originalSize(Integer originalSize) {
  ...
  */
  ...
  public SmoothGradeStreamDTO resolution(ResolutionEnum resolution) {
  ...
  */
  ...
  public SmoothGradeStreamDTO seriesType(SeriesTypeEnum seriesType) {
  ...
  */
  ...
  public SmoothGradeStreamDTO data(List<Float> data) {
    this.data = data;
    return this;
  }

  public SmoothGradeStreamDTO addDataItem(Float dataItem) {
    if (this.data == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SmoothGradeStreamDTO smoothGradeStream = (SmoothGradeStreamDTO) o;
  ...
  public String toString() {
    ...
    sb.append("class SmoothGradeStreamDTO {\n");
