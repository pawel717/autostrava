 ...
 */
@JsonPropertyOrder({
  SmoothGradeStreamDTO.JSON_PROPERTY_ORIGINAL_SIZE,
  SmoothGradeStreamDTO.JSON_PROPERTY_RESOLUTION,
  SmoothGradeStreamDTO.JSON_PROPERTY_SERIES_TYPE,
  SmoothGradeStreamDTO.JSON_PROPERTY_DATA
})
