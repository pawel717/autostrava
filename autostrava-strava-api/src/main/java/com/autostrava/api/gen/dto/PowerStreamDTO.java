 ...
 */
@JsonPropertyOrder({
  PowerStreamDTO.JSON_PROPERTY_ORIGINAL_SIZE,
  PowerStreamDTO.JSON_PROPERTY_RESOLUTION,
  PowerStreamDTO.JSON_PROPERTY_SERIES_TYPE,
  PowerStreamDTO.JSON_PROPERTY_DATA
})
