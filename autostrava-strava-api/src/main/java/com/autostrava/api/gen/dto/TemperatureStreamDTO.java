 ...
 */
@JsonPropertyOrder({
  TemperatureStreamDTO.JSON_PROPERTY_ORIGINAL_SIZE,
  TemperatureStreamDTO.JSON_PROPERTY_RESOLUTION,
  TemperatureStreamDTO.JSON_PROPERTY_SERIES_TYPE,
  TemperatureStreamDTO.JSON_PROPERTY_DATA
})
