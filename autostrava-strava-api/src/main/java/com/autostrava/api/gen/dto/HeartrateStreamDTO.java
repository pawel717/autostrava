 ...
 */
@JsonPropertyOrder({
  HeartrateStreamDTO.JSON_PROPERTY_ORIGINAL_SIZE,
  HeartrateStreamDTO.JSON_PROPERTY_RESOLUTION,
  HeartrateStreamDTO.JSON_PROPERTY_SERIES_TYPE,
  HeartrateStreamDTO.JSON_PROPERTY_DATA
})
