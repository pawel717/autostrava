...
import com.autostrava.api.gen.dto.HeartrateStreamAllOfDTO;
...
public class HeartrateStreamDTO   {
  ...
  public HeartrateStreamDTO originalSize(Integer originalSize) {
  ...
  */
  ...
  public HeartrateStreamDTO resolution(ResolutionEnum resolution) {
  ...
  */
  ...
  public HeartrateStreamDTO seriesType(SeriesTypeEnum seriesType) {
  ...
  */
  ...
  public HeartrateStreamDTO data(List<Integer> data) {
    this.data = data;
    return this;
  }

  public HeartrateStreamDTO addDataItem(Integer dataItem) {
    if (this.data == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HeartrateStreamDTO heartrateStream = (HeartrateStreamDTO) o;
  ...
  public String toString() {
    ...
    sb.append("class HeartrateStreamDTO {\n");
