...
import com.autostrava.api.gen.dto.DistanceStreamAllOfDTO;
...
public class DistanceStreamDTO   {
  ...
  public DistanceStreamDTO originalSize(Integer originalSize) {
  ...
  */
  ...
  public DistanceStreamDTO resolution(ResolutionEnum resolution) {
  ...
  */
  ...
  public DistanceStreamDTO seriesType(SeriesTypeEnum seriesType) {
  ...
  */
  ...
  public DistanceStreamDTO data(List<Float> data) {
    this.data = data;
    return this;
  }

  public DistanceStreamDTO addDataItem(Float dataItem) {
    if (this.data == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DistanceStreamDTO distanceStream = (DistanceStreamDTO) o;
  ...
  public String toString() {
    ...
    sb.append("class DistanceStreamDTO {\n");
