 ...
 */
@JsonPropertyOrder({
  DistanceStreamDTO.JSON_PROPERTY_ORIGINAL_SIZE,
  DistanceStreamDTO.JSON_PROPERTY_RESOLUTION,
  DistanceStreamDTO.JSON_PROPERTY_SERIES_TYPE,
  DistanceStreamDTO.JSON_PROPERTY_DATA
})
