 ...
 */
@JsonPropertyOrder({
  SummaryGearDTO.JSON_PROPERTY_ID,
  SummaryGearDTO.JSON_PROPERTY_RESOURCE_STATE,
  SummaryGearDTO.JSON_PROPERTY_PRIMARY,
  SummaryGearDTO.JSON_PROPERTY_NAME,
  SummaryGearDTO.JSON_PROPERTY_DISTANCE
})
